...
const SNAKE_HEAD_COLOR: Color = Color::rgb(0.7, 0.6, 0.6);
...
fn check_quit(mut exit: EventWriter<AppExit>, keyboard_input: Res<Input<KeyCode>>)
{
...
fn position_translation(windows: Res<Windows>, mut q: Query<(&Position, &mut Transform)>) {
    fn convert(pos: f32, bound_window: f32, bound_game: f32) -> f32 {
        ...
        pos / bound_game * bound_window - (bound_window * 0.5) + (tile_size / 2.)
    }
